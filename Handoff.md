...
- Natural stop is active while both long jobs remain healthy: source-native tmux `medrec-baseline-molerec-20260917-180500-paperdev` at `/root/zhb/medrec-data/runs/molerec/medrec-baseline-molerec-20260917-180500-paperdev`, and frozen-profile formal tmux `medrec-profile-formal-20260917` at `/root/zhb/medrec-data/runs/molerec/medrec-profile-formal-20260917` (one epoch complete at the last snapshot). Recheck terminal artifacts and independent audits before any table promotion.
