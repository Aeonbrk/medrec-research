#!/usr/bin/env python3
"""Execution runner for MoleRec smoke and formal training/testing lanes."""
...
if __package__:
    ...
    from .molerec_logs import parse_test_log, parse_training_log, select_checkpoint
...
def run_smoke_lane(
    *,
    ...
    mod = (
        dispatch_module
        or sys.modules.get("molerec_program")
        or sys.modules.get("baselines.molerec")
        or sys.modules.get("molerec")
    ...
    if missing:
        raise ReproductionError(f"MoleRec dataset is missing required inputs: {missing}")
