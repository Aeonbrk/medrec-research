...
- **Authority:** This focused plan governs the three-model execution. The pinned SafeDrug source owns model behavior. `docs/playbooks/REMOTE_319_EXECUTION_PLAYBOOK.md` owns the 319 operating boundary. `docs/plans/2026-07-16-011-feat-researcher-hitl-reproduction-loop-plan.md` remains broader follow-up context.
