...
Source review run: `20260811-163710-3c195230` (historical HITL reproduction-loop review; the superseded plan was removed from the active tree on `2026-08-23`).
